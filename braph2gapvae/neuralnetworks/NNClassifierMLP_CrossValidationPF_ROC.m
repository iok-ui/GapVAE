	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case NNClassifierMLP_CrossValidationPF_ROC.ELCLASS % __NNClassifierMLP_CrossValidationPF_ROC.ELCLASS__
					prop_default = 'NNClassifierMLP_CrossValidationPF_ROC';
				case NNClassifierMLP_CrossValidationPF_ROC.NAME % __NNClassifierMLP_CrossValidationPF_ROC.NAME__
					prop_default = 'ROC Panel for Cross-Validation MLP Classifier';
				case NNClassifierMLP_CrossValidationPF_ROC.DESCRIPTION % __NNClassifierMLP_CrossValidationPF_ROC.DESCRIPTION__
				...
				case NNClassifierMLP_CrossValidationPF_ROC.TEMPLATE % __NNClassifierMLP_CrossValidationPF_ROC.TEMPLATE__
					prop_default = Format.getFormatDefault(8, NNClassifierMLP_CrossValidationPF_ROC.getPropSettings(prop));
				case NNClassifierMLP_CrossValidationPF_ROC.ID % __NNClassifierMLP_CrossValidationPF_ROC.ID__
					prop_default = 'NNClassifierMLP_CrossValidationPF_ROC ID';
				case NNClassifierMLP_CrossValidationPF_ROC.LABEL % __NNClassifierMLP_CrossValidationPF_ROC.LABEL__
					prop_default = 'NNClassifierMLP_CrossValidationPF_ROC label';
				case NNClassifierMLP_CrossValidationPF_ROC.NOTES % __NNClassifierMLP_CrossValidationPF_ROC.NOTES__
