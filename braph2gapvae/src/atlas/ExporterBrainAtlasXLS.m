	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ExporterBrainAtlasXLS.ELCLASS % __ExporterBrainAtlasXLS.ELCLASS__
					prop_default = 'ExporterBrainAtlasXLS';
				case ExporterBrainAtlasXLS.NAME % __ExporterBrainAtlasXLS.NAME__
					prop_default = 'Brain Atlas Exporter in XLS Files';
				case ExporterBrainAtlasXLS.DESCRIPTION % __ExporterBrainAtlasXLS.DESCRIPTION__
					prop_default = 'A Brain Atlas Exporter in XLS Files (ExporterBrainAtlasXLS) exports a brain atlas to an XLS/XLSX file.';
				case ExporterBrainAtlasXLS.TEMPLATE % __ExporterBrainAtlasXLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ExporterBrainAtlasXLS.getPropSettings(prop));
				case ExporterBrainAtlasXLS.ID % __ExporterBrainAtlasXLS.ID__
					prop_default = 'ExporterBrainAtlasXLS ID';
				case ExporterBrainAtlasXLS.LABEL % __ExporterBrainAtlasXLS.LABEL__
					prop_default = 'ExporterBrainAtlasXLS label';
				case ExporterBrainAtlasXLS.NOTES % __ExporterBrainAtlasXLS.NOTES__
