classdef ConcreteElement < Element
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ConcreteElement'  'NNClassifierMLP_EvaluatorPF_ROC'  'NNClassifierMLP_CrossValidationPF_ROC'  'NNClassifierMLP_CrossValidation'  'NNClassifierMLP_Evaluator'  'NNClassifierMLP'  'ExporterBrainAtlasXLS'  'ImporterBrainAtlasXLS'  'BrainSurfacePF'  'BrainSurface'  'BrainRegion'  'BrainAtlasPF'  'BrainAtlas'  'NNDataProcess_Tabular'  'ExporterGroupSubjectST_XLS'  'ImporterGroupSubjectST_XLS'  'NNDataPoint_Image'  'NNDataPoint_Structural'  'NNDataPoint_Tabular'  'NNDatasetProcess'  'NNDatasetProcess_MNIST'  'NNDatasetProcess_Structural'  'NNDatasetProcess_Tabular'  'NNVariationalAutoencoder'  'NNVariationalAutoencoderEvaluator_Structural'  'NNVariationalAutoencoder2DCNN'  'NNVariationalAutoencoderEvaluator'  'NNVariationalAutoencoderEvaluator_Image'  'NNVariationalAutoencoderMLP'  'SubjectST'  'Group'  'Subject'  'SubjectPP_VOIDict'  'VOI'  'VOICategoric'  'VOINumeric'  'IndexedDictionary'  'ExporterPipelineBRAPH2'  'GUI'  'GUIElement'  'GUIFig'  'GUILayout'  'ImporterPipelineBRAPH2'  'Panel'  'PanelElement'  'PanelFig'  'PanelProp'  'PanelPropAlpha'  'PanelPropCell'  'PanelPropClass'  'PanelPropClassList'  'PanelPropColor'  'PanelPropIDict'  'PanelPropIDictTable'  'PanelPropItem'  'PanelPropItemList'  'PanelPropLine'  'PanelPropLogical'  'PanelPropMarker'  'PanelPropMatrix'  'PanelPropNet'  'PanelPropOption'  'PanelPropRVectorSmart'  'PanelPropRVectorView'  'PanelPropScalar'  'PanelPropSize'  'PanelPropString'  'PanelPropStringList'  'PanelPropStringTextArea'  'Pipeline'  'PipelineCode'  'PipelinePP_Notes'  'PipelinePP_PSDict'  'PipelineSection'  'Settings'  'SettingsAmbient'  'SettingsAmbientPP'  'SettingsArea'  'SettingsAreaPP'  'SettingsAxis'  'SettingsAxisPP'  'SettingsLine'  'SettingsLinePP'  'SettingsPP'  'SettingsPosition'  'SettingsPositionPP'  'SettingsSphere'  'SettingsSurface'  'SettingsSurfacePP'  'SettingsSymbol'  'SettingsText'  'SettingsTextPP'  'GTA_AL'  'GTA_CA'  'GTA_CO'  'GTA_DI'  'GTA_EM'  'GTA_IT'  'GTA_LL'  'GTA_LN'  'GTA_LO'  'GTA_MR'  'GTA_NC'  'GTA_NM'  'GTA_NN'  'GTA_NR'  'GTA_NS'  'GTA_OP'  'GTA_PanelProp'  'GTA_ST'  'GTA_ST_TA'  'GTA_SZ'  'NNBase'  'NNCrossValidation'  'NNDataPoint'  'NNDataset'  'NNDatasetCombine'  'NNDatasetSplit'  'NNEvaluator'  'Exporter'  'Importer' }; %CET: Computational Efficiency Trick
		end
