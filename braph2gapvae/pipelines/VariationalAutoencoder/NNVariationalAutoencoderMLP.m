classdef NNVariationalAutoencoderMLP < NNVariationalAutoencoder
	...
	%  <strong>24</strong> <strong>SIZE_INPUT</strong> 	SIZE_INPUT (parameter, scalar) is the size of the input data once flattened (scalar number of features).
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 10 % NNVariationalAutoencoderMLP.DP_CLASSES
					prop_default = {'NNDataPoint' 'NNDataPoint_RamanSpectra' 'NNDataPoint_Image' 'NNDataPoint_Structural'};
