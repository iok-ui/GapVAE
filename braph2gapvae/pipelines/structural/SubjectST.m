	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case SubjectST.ELCLASS % __SubjectST.ELCLASS__
					prop_default = 'SubjectST';
				case SubjectST.NAME % __SubjectST.NAME__
					prop_default = 'Structural Subject';
				case SubjectST.DESCRIPTION % __SubjectST.DESCRIPTION__
					prop_default = 'SubjectST with structural data (e.g. cortical thickness obtaibed from strcutural MRI) for each brain region.';
				case SubjectST.ID % __SubjectST.ID__
					prop_default = 'SubjectST ID';
				case SubjectST.LABEL % __SubjectST.LABEL__
					prop_default = 'SubjectST label';
				case SubjectST.NOTES % __SubjectST.NOTES__
