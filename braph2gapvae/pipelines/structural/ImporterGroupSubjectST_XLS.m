	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ImporterGroupSubjectST_XLS.ELCLASS % __ImporterGroupSubjectST_XLS.ELCLASS__
					prop_default = 'ImporterGroupSubjectST_XLS';
				case ImporterGroupSubjectST_XLS.NAME % __ImporterGroupSubjectST_XLS.NAME__
					prop_default = 'Structural Subject Group XLS Importer';
				case ImporterGroupSubjectST_XLS.DESCRIPTION % __ImporterGroupSubjectST_XLS.DESCRIPTION__
				...
				case ImporterGroupSubjectST_XLS.TEMPLATE % __ImporterGroupSubjectST_XLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ImporterGroupSubjectST_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_XLS.ID % __ImporterGroupSubjectST_XLS.ID__
					prop_default = 'ImporterGroupSubjectST_XLS ID';
				case ImporterGroupSubjectST_XLS.LABEL % __ImporterGroupSubjectST_XLS.LABEL__
					prop_default = 'ImporterGroupSubjectST_XLS label';
				case ImporterGroupSubjectST_XLS.NOTES % __ImporterGroupSubjectST_XLS.NOTES__
