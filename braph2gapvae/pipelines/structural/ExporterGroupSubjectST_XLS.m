	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case ExporterGroupSubjectST_XLS.ELCLASS % __ExporterGroupSubjectST_XLS.ELCLASS__
					prop_default = 'ExporterGroupSubjectST_XLS';
				case ExporterGroupSubjectST_XLS.NAME % __ExporterGroupSubjectST_XLS.NAME__
					prop_default = 'Structural Subject Group XLS Exporter';
				case ExporterGroupSubjectST_XLS.DESCRIPTION % __ExporterGroupSubjectST_XLS.DESCRIPTION__
				...
				case ExporterGroupSubjectST_XLS.TEMPLATE % __ExporterGroupSubjectST_XLS.TEMPLATE__
					prop_default = Format.getFormatDefault(8, ExporterGroupSubjectST_XLS.getPropSettings(prop));
				case ExporterGroupSubjectST_XLS.ID % __ExporterGroupSubjectST_XLS.ID__
					prop_default = 'ExporterGroupSubjectST_XLS ID';
				case ExporterGroupSubjectST_XLS.LABEL % __ExporterGroupSubjectST_XLS.LABEL__
					prop_default = 'ExporterGroupSubjectST_XLS label';
				case ExporterGroupSubjectST_XLS.NOTES % __ExporterGroupSubjectST_XLS.NOTES__
